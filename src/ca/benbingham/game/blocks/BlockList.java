...
public class BlockList {
    ...
    public void init() {
        blockList.add(AIR = new Block(EBlockName.AIR, getNextID(), new Image("textures/blocks/air.png", NEBULA_BUFFERED_IMAGE)));

        blockList.add(STONE = new Block(EBlockName.STONE, getNextID(), new Image("textures/blocks/stone.png", NEBULA_BUFFERED_IMAGE)));
        blockList.add(GRASS = new Block(EBlockName.GRASS, getNextID(), new Image("textures/blocks/grass_side.png", NEBULA_BUFFERED_IMAGE), new Image("textures/blocks/grass_top.png", NEBULA_BUFFERED_IMAGE), NEBULA_TOP_FACE, new Image("textures/blocks/dirt.png", NEBULA_BUFFERED_IMAGE), NEBULA_BOTTOM_FACE));
        blockList.add(DIRT = new Block(EBlockName.DIRT, getNextID(), new Image("textures/blocks/dirt.png", NEBULA_BUFFERED_IMAGE)));
        blockList.add(BEDROCK = new Block(EBlockName.BEDROCK, getNextID(), new Image("textures/blocks/bedrock.png", NEBULA_BUFFERED_IMAGE)));
